...
<div class="row" style="padding:5px">
  ...
  <!-- <div class="row"> -->
    <?php
try {
   $sql = "SELECT * FROM drugs WHERE 1 AND status ='I' Limit 12";
   $stmt = $DB->prepare($sql);
...
if ($resu> 0){  
?>
<div class="row breadcrumb required" style="padding-left: 10px; padding-right: 10px;"><a href="view_drugs.php" title="Click to view Full list" target="_blank">Missing Drugs:</a>  <?php foreach ($vistt as $vt) { echo $vt["drug"].' ' ; ?>,<?php } ?>
<?php };?>
</div>
</div>
<div class="container">
      ...
      <div class="panel-body" style="height:auto">
			...
			<form class="form-horizontal" Autocomplet="off" style="height:auto" name="vist_form" id="visit_form" enctype="multipart/form-data" method="post" action="process_form.php">
                      <fieldset>
                                ...
                                <input type="hidden" value="<?php echo ucwords($_SESSION['fname']." ".$_SESSION['lname'])?>"  required class="form-control" name="prescribed_by">
				<table class="table table-striped table-hover table-bordered ">
					<tbody><tr>
						<th></th>
					  </tr>
					  <tr>					  
                               <td><input type="submit" class="btn btn-primary btn-lg centre" onClick="return confirm('Are you sure?')" name="psb" value=" Submit Prescription !" /></td>
						</tr>
					</tbody></table>	
                      </fieldset>
					  <script>
