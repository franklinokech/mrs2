...
<head>
    ...
    <!-- <link href="bootstrap/css/small-business.css" rel="stylesheet"> -->
          <script src="../elements/jquery-1.9.0.min.js"></script>
...
<body>
    <div class="navbar navbar-default navbar navbar-inverse header" role="navigation">
                            ...
                            <a href="../messages/send_message.php?mode=read">
                                <div class="media">
                                    <span class="pull-left">
                                        <img class="media-object img-circle" src="http://placehold.it/50x50" alt="" >
                                    </span>
