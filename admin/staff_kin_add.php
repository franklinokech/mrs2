...
<div class="container">
      <div class="row">
        <ul class="breadcrumb">
            ...
            <li><a href="staff_patient.php">Staff Patients</a></li>
            <li><a href="view_pattient_staff.php">View Patient</a></li>
            <li class="active"> Next Of Kin </li>
          </ul>
      </div>
          ...
          <fieldset>
            ...
            <div class="form-group">
              <div class="col-lg-3 col-lg-offset-4">
                <input type="submit" name="kin_add" class="btn btn-primary" value="Add <?php echo ucwords($res['first_name'].' Next of Kin')?>"</>
