...
try {
  ...
  if ($keyword <> "" ) {
    ...
    $varr=3;
    $sql = "SELECT * FROM visit WHERE reg_no='{$reg_no}' ORDER BY visit_no DESC ";
    $stmt = $DB->prepare($sql);
  }
  ...
  <div class="panel panel-success">
    ...
    <div class="panel-body">
      ...
      <div class="col-lg-12" style="padding-left: 0; padding-right: 0;" >
        <form action="speceific_generate.php" method="get" >
  ...
  for ($i = 1; $i <= $last; $i++) {
    if ($i == $pagenum) {
      ?>
                ...
                ?>
                <li><a href="specific-generate.php?pagenum=<?php echo $i; ?>&keyword=<?php echo $_GET["keyword"]; ?>" class="links"  onclick="displayRecords('<?php echo $page_limit; ?>', '<?php echo $i; ?>');" ><?php echo $i ?></a></li>
                <?php
              }
            }
            ?>
