...
<div class="row">
  ...
  <div class="row">
    <div class="col-md-8">
            <script src="../elements/jQuery.print.js"></script> 
            <script>
      ...
      <div id='print-div2' class="print_div">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-12">
                                      ...
                                      <br />
                                      <br />
                                      The above named person attended this hospital on the above specified date and was had the following symptoms. <?php echo $pherm['signs'] ; ?> <br/>

                                      <?php if($visit['test']== !"" ){ ?>
                                        The patient was diagnosed with: <?php echo($visit['result']); ?>
